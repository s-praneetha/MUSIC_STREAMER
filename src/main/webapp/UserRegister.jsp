...
<body>
<form class='login-form' name="form" action = "UserController" method="POST" onsubmit="return validate()">
  <div class="flex-row">
...
<br>
<a class='lf--forgot' href='login.jsp'>Existing User?</a>
...
<div class="container">
	...
	<form name="form" action = "UserController" method="POST" onsubmit="return validate()">
