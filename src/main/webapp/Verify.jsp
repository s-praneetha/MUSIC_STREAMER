...
<center><h3 style="color:white;margin-top:-50px;">We have sent a verification code to your respective email.</h3><br><p  style="color:white;"> Please type the code to get verified</p></center>

<form class='login-form' name="form" action = "VerifyCode" method="POST">
  <div class="flex-row">
